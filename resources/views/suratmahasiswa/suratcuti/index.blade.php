            ...
            <div class="card mx-auto">
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <form action="/suratcuti/simpan" method="POST">
                            @csrf
                            <input type="hidden" name="tipe" value="suratcuti">
                            ...
                            <div class="form-group">
                                <label for="state">Durasi:</label>
                                <input type="number" name="durasi" class="form-control"  id="durasi" placeholder="Durasi Cuti" autofocus required>
                            </div>
