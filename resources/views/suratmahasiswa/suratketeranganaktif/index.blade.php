                ...
                <div class="container">
                    ...
                    <form id="formvalidation" action="https://www.sea.playblackdesert.com/Main/Index">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control">
                                <option class="disabled">Please Choose</option>
                                <option>Mengurus Tunjangan Gaji Orang Tua</option>
                                <option>Mengurus BPJS/Asuransi/Berkas Lainnya</option>
                                <option>Mengurus Surat Kehilangan</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="check" class="btn btn-warning btn-lg btn-block text-white">Ajukan Surat</button>
                        <br>
                        <br>
                    </form>
                </div>
