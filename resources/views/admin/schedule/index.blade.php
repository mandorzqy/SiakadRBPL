...
<div class="container justify-content-center ">
    ...
    <div class="row d-flex justify-content-center">
      ...
      <tr>
        ...
        <td>
            <div class="row ">
              <a class="btn btn-info col" href={{url('admin/schedule/'.$schedule->id.'/edit')}}><i class="bi bi-pencil-square"></i></a>
              <form class="col" action="{{url('admin/schedule/'.$schedule->id)}}" method="POST">
                @csrf
